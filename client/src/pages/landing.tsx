    ...
    <div className={`min-h-screen bg-background ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section className="relative overflow-hidden py-20 lg:py-32">
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-6 gradient-text ${isRTL ? "leading-[1.35] inline-block pb-2 [font-family:'IBM_Plex_Sans_Arabic',var(--font-ar)]" : 'leading-tight'}`}>
              {tr.heroTitle}
            </h1>
