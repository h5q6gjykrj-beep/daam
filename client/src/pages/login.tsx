              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="bg-black/20 border-white/10 h-12 text-base focus:border-primary/50 transition-colors ps-12"
                    dir="ltr"
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="icon"
                    className="absolute start-0 top-0 h-12 w-12 hover:bg-transparent"
